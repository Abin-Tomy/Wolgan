...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  headerCta:
    "btn-fill-effect btn-fill-white hidden md:inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-full text-sm font-medium tracking-wide border border-white/30 text-white transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shrink-0 group",
  heroServicesCta:
    "btn-fill-effect btn-fill-dark inline-flex h-14 items-center justify-center rounded-full border border-white/70 bg-white px-10 text-base font-medium text-[#0A1F3C] transition-all hover:scale-[1.02] active:scale-[0.98]",
  heroContactCta:
    "btn-fill-effect btn-fill-white inline-flex h-14 items-center justify-center rounded-full border border-white/70 px-10 text-base font-medium text-white transition-all hover:scale-[1.02] active:scale-[0.98]",
  primaryBrand:
