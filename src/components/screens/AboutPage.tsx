          ...
          <div className="container mx-auto px-6 md:px-14">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_560px] gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
              ...
              <div className="flex justify-center items-center w-full">
                <div className="relative w-full" style={{ height: "370px", maxWidth: "564px", margin: "0 auto" }}>
                  ...
                  <div className="absolute" style={{ top: "0px", left: "212px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
                  ...
                  <div className="absolute" style={{ top: "0px", left: "424px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
                  ...
                  <div className="absolute" style={{ top: "106px", left: "106px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
                  ...
                  <div className="absolute" style={{ top: "106px", left: "318px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
                  ...
                  <div className="absolute" style={{ top: "212px", left: "0px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
                  ...
                  <div className="absolute" style={{ top: "212px", left: "212px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
                  ...
                  <div className="absolute" style={{ top: "212px", left: "424px" }}>
                    <div className="diamond-card-wrap">
                      <div className="diamond-card-inner">
