      ...
      <section className="py-16 px-6 relative bg-[#f8f9fa] overflow-hidden">
        ...
        <div className="relative z-10 pt-10 flex flex-col gap-10">
          ...
          <div className="mobile-anim-up flex flex-col items-center gap-6">
            ...
            <Button variant="primaryBrand" href="/api/download?file=Wolgan - Profile.pdf" download="Wolgan - Profile.pdf" className="w-full h-14 justify-center text-sm shadow-xl rounded-full">
              Company Profile
            </Button>
          </div>
