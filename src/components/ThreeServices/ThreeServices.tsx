    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute top-16 inset-x-0 flex flex-col items-center gap-3 z-10 pointer-events-none">
                    <span className="px-3 py-1 border border-black/10 rounded-full text-[9px] uppercase tracking-[0.35em] text-black/40">
                        Our Services
                    </span>
                    <h1
                        className="font-montserrat font-normal text-[#0A1F3C]/90 leading-tight text-center"
                ...
                {/* Service content overlay — Centered Vertically */}
                <div className="absolute inset-0 flex items-center pointer-events-none z-10">
                    <div
                        className="pointer-events-auto w-full md:w-[42%] px-8 md:px-12 flex flex-col gap-6"
                        style={{
                    ...
                    >
                        <p className="text-xs uppercase tracking-[0.3em]" style={{ color: "#C5A059", opacity: 0.8 }}>
                            {String(activeIndex + 1).padStart(2, "0")} / {String(servicesData.length).padStart(2, "0")}
                        </p>

                        <h2
                            key={`heading-${activeIndex}`}
                            className="text-3xl md:text-4xl lg:text-5xl font-montserrat font-normal leading-tight animate-fade-in"
                            style={{ color: "#0A1F3C" }}
                        >
                            {service.heading}
                        </h2>
                        ...
                        <p
                            ...
                            className="text-sm md:text-base leading-relaxed max-w-sm animate-fade-in"
                            style={{ color: "rgba(10,31,60,0.65)" }}
                        >
                            {service.description}
                        </p>
                        ...
                        <a
                            ...
                            className="btn-fill-effect relative inline-flex w-fit items-center gap-3 px-8 py-3 rounded-full border border-[#0A1F3C]/20 text-[#0A1F3C] text-sm font-semibold tracking-wide overflow-hidden group pointer-events-auto transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                        >
                        ...
                        {isVisible && (
                            <p className="text-[10px] uppercase tracking-[0.35em] mt-4" style={{ color: "rgba(0,0,0,0.25)" }}>
                                scroll to explore
                            </p>
                        )}
                    </div>
